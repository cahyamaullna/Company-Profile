    ...
    <footer class="grey darken-4 white-text">
        ...
        <div class="row">
            ...
            <div class="col m3">
                <h6>Contact</h6>
                <ul class="list">
                    <li><a href="https://mailto:aisyahhumairohsalsabila@smkwikrama.sch.id" target="_blank"><i class="material-icons left white-text" style="font-size : large">email <strong style="font-size : medium">{{ $email ?? 'notfound' }}</strong></i></a></li>
                    <li><a href="https://wa.me/+6285281351949" target="_blank"><i class="material-icons left white-text" style="font-size : large">phone <strong style="font-size : medium">{{ $phone ?? 'notfound' }}</strong></i></a></li>
